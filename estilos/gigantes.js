  ...
  try {
    ...
    <p>    
        Temperatura: <b> ${info.feelslike_c}° </b> <br>
           Ventos:  ${info.gust_kph} Km/H <br>
           Umidade:  <b> ${info.humidity}% </b> <br>
...
createApp({
  data() {
    return {
      listrefugios1: [
        { nombre: "Do Pilar", telefono: 3514215283 },
        { nombre: "Aldeia Amelita", telefono: 3541628510 },
        { nombre: "Novas Casas", telefono: 3541608466 },
        { nombre: "Novas Casas", telefono: 3515578068 },
      ],
    };
  },
}).mount("#refugios1");
